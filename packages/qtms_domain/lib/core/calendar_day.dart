...
final class CalendarDay implements Comparable<CalendarDay> {
  ...
  /// ★★ **اليوم مقروءاً — `YYYY/MM/DD` بالأرقام اللاتينية**.
  ///
  /// ⛔⛔★★ **ولماذا في النطاق لا في طبقة عرض التطبيق:** ★ **له قارئان**
  /// — **الشاشة** (`date_labels.dart` **تُفوِّض إليها** ⛔ **ولا تنسخها**)
  /// **والعملية السحابية** التي تكتب **البيان الآلي لتطبيق الفائض**
  /// (`FR-M12-11`) **نصّاً مخزَّناً يقرؤه المستخدم**. ⟵ **ونسختان للصيغة
  /// تُنتجان تاريخين مختلفين للحدث نفسه** (`coding-standards.md` §2.2).
  ///
  /// ★ **والأرقام لاتينية (0-9) قيمةً وحيدة ثابتة** (`AM-003`) — ⛔ **لا
  /// خياراً ولا أرقاماً هندية**، ★ **والصيغة نفسُها في الشاشة والمخزَّن.**
