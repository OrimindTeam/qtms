...
enum DealerLedgerEntryType {
  ...
  /// ★ قبض — **يكتبه سند القبض** (`M12` · `WU-007`).
  ///
  /// ⛔⛔★★ **وحركةٌ دائنة لكل سطر لا واحدةٌ مجمّعة** (`FR-M12-07` ·
  /// `BR-M12-01`) — ★ **لأن كل سطر يخصّ ضماراً ومصدراً مختلفاً.**
  receipt,

  /// ★★ تطبيق فائض — ⛅ **تكتبه السحابة عند إنشاء ضمارٍ جديد** (`FR-M12-11`).
  ///
  /// ⚠️⚠️ **ونوعٌ مستقلٌّ عن [receipt] عمداً** — ★ **رغم أن كليهما دائن**:
  /// ⟵ **فالقبض نقدٌ دخل الصندوق اليوم**، ★ **وتطبيق الفائض نقدٌ دخل قبل
  /// أيام ويُنسَب لضمارٍ اليوم** — ⛔ **وجمعُهما في نوعٍ واحد كان يُفسِد
  /// «المقبوض في تاريخ» بمبلغٍ لم يدخل الصندوق فيه** (`GR-41` · `FR-M12-20`).
  surplusApplication,

  /// ★ خصم — **يكتبه سند الخصم** (`M13` · `WU-013`).
  ///
  /// ⛔⛔★★★ **ونوعٌ مستقلٌّ عن [receipt] قطعاً — وهذا هو `ت-04` بنيوياً**
  /// (`FR-M13-08` · `GR-40` · `OQ-001`): ★ **كلاهما دائنٌ يُنقِص الضمار**،
  /// ⟵ **لكن القبضَ نقدٌ دخل الصندوق والخصمَ إسقاطُ دَينٍ بلا نقد** —
  /// ⛔ **وجمعُهما في نوعٍ واحد كان يُدخِل الخصمَ في «الواصل»** فيُظهر
  /// المقوتَ وكأنه سدّد مالاً لم يدفعه (`FR-M15-06-أ`)، ★ **ويُفقِد المالكَ
  /// معرفةَ كم أسقط فعلاً** ⟵ **وهو البند الذي يعرضه `FR-M15-03` مستقلاً.**
  ///
  /// ⛔⛔★★ **وفي شاشة حركة النقد يُعرَض للعلم ولا يُطرَح**
  /// (`schema/discounts.md` القاعدة 4) — ★ **لأنه لم يدخل نقدٌ أصلاً**،
  /// ⟵ **وهذا النوعُ هو ما يُمكِّن تلك الشاشة من التفريق.**
  discount,
}
