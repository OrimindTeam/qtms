...
///
/// ⚠️⚠️★★★ **وحدُّ هذه القاعدة يُقرأ بدقّة بعد [`ADR-0024`]** ⏳ **مقترح:**
/// ★ **القاعدةُ تخصّ هذا المستودعَ ودفاترَ النظام** — ⟵ **فلا حقلَ كلمةِ
/// مرورٍ في `users/{userId}`** (`FR-M1-02`) ⛔ **ولا في أي مستندٍ ولا قيدِ
/// تدقيق**، ★ **وهو قائمٌ بلا مساس.**
///
/// ★★ **وخزنةُ الجهاز الآمنة شيءٌ آخر تماماً** (`CredentialVault`) — ⟵ **سرٌّ
/// يخصّ *جهازاً واحداً* بإذن *صاحبه* داخل `Android Keystore`** ⛔ **لا حقلٌ
/// في دفترٍ يقرؤه غيرُه**: ★ **و`authentication-policy.md` §6 يمنع الحفظَ
/// «بلا حماية النظام» وحدَه** ⛔ **لا الحفظَ مطلقاً.**
abstract interface class AuthRepository {
  ...
  /// ★★★ **يُغيِّر كلمةَ مرور صاحب الجلسة** — [`CR-012`] ⏳ · `AM-012` §5.3.
  ///
  /// ═══════════════════════════════════════════════════════════════════════
  /// ⛔⛔★★★ **وإعادةُ المصادقة بالكلمة الحالية شرطٌ لا خيار:**
  /// ★ **جهازٌ تُرك مفتوحاً بجلسةٍ قائمة يُمكِّن من بجانبه من تغيير الكلمة**
  /// ⟵ **فيقفل صاحبَ الحساب خارج حسابه** — ⛔ **والكلمةُ الحالية هي ما يمنع
  /// ذلك**، ★ **وخدمةُ المصادقة تشترطها أصلاً للعمليات الحسّاسة.**
  ///
  /// ⛔⛔ **ولا تُخزَّن أيٌّ من الكلمتين في أي دفتر** — ★ **العمليةُ في خدمة
  /// المصادقة وحدها** ⟵ **ولا مستندَ يُكتَب** ⛔ **ولا قاعدةَ حمايةٍ تُمَسّ.**
  ///
  /// ⚠️ **والرفضُ يُصنَّف بـ[SignInRejection] نفسِه** — ⛔ **ولا تصنيفَ ثانٍ:**
  /// ★ **`invalidCredentials` تعني «الحالية غير صحيحة»**، ⟵ **والباقي كما هو**
  /// (`accountDisabled` · `lockedOut` · `noConnection` · `unexpected`).
  /// ═══════════════════════════════════════════════════════════════════════
