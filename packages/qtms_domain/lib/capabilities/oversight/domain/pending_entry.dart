...
///
/// ⚠️⚠️★★ **ولذلك `M22` (السحبيات — «بند قات بلا سعر» · `FR-M22-07`) غائبٌ
/// عمداً**: ⛔ **لا وحدةَ سحبياتٍ منفَّذة بعد** (`WU-014` — المرحلة الثانية)،
/// ⟵ **فلا كاتبَ يُنشئ بندَه ولا حقلَ يُدخَل منه.** ★ **ويُضاف في زيادته
/// بقيمةٍ واحدة هنا وسطرٍ في [PendingMissingField]** ⛔ **لا قبلها.**
...
// ═════════════════════════════════════════════════════════════════════════
// الحقل الناقص — ★ **خمسةٌ لا تسعة، ولماذا**
// ═════════════════════════════════════════════════════════════════════════

/// ★★★ **الحقل المُلاحَق** — **مفتاحٌ ثابتٌ يدخل معرّف البند**.
///
/// ═══════════════════════════════════════════════════════════════════════
/// ⚠️⚠️★★★ **ولماذا خمسةٌ بينما `FR-SYS-08` يعدّ تسعة أسماء — مقروءٌ من
