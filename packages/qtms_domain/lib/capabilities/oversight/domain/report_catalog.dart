...
/// تُري المستخدم فراغاً يظنّه عطلاً**، ★ **والخمسةُ والعشرون هنا نطاقُ
/// `WU-011` و`WU-018` معاً** ⛔ **والبقيةُ تُضاف في زياداتها.**
///
/// ⛔⛔★★★ **و`R-07` مؤجَّلٌ إلى `WU-020` بقرارٍ معلَن لا سهو:** ★ **عنوانُه
/// في `FR-M19` §2 «الوزن الضائع والسكرب **والإتلاف**»**، ⛔ **ولا كاتبَ
/// للإتلاف في النظام بعد** (`M21` · **المرحلة الثالثة**): ⟵ **فبناؤه اليوم
/// إمّا يَعِد بما لا يفعل** (`DEBT-72`: «⛔⛔ **ولا يُوصَف التقريرُ بما لا
/// يفعله**») **أو يُعرَض بعنوانٍ يخالف متطلباً معتمداً** ⛔ **وكلاهما مرفوض.**
///
...
/// ★★ التقارير المبنيّة فعلاً — **خمسةٌ وعشرون من واحدٍ وثلاثين**.
///
