  ...
  required Map<String, Object?> valuesAfter,
    ...
    AuditEntry(
      ...
      target: AuditTarget(
        ...
        // ★★★ **ورقمُ المستند يُكتَب مع المعرّف** — `AM-025` §2 ② (2026-09-17):
        //    ⚠️⚠️ **وعطلُ عرضٍ مقيسٌ بلقطةٍ فعلية:** ⛔ **سطرُ الهدف في سجل
        //    التدقيق كان «التوزيع: `MQT-0002_SRC-001_20260905`»** — ★ **معرّفاً
        //    مركّباً خاماً**، ⟵ **بينما شاشةُ التوزيع تعرض لنفس السجل
        //    «`DST-20260905-0002`»**: ⛔ **وهو «مصطلحٌ تقني في واجهة المستخدم»**
        //    (`ui-guidelines.md` §6). ★ **والقيدُ يملك الرقمَ في الطلب نفسِه**
        //    ⟵ **فكتابتُه مصدرُ الحقيقة** ⛔ **لا فكُّ المعرّف في الشاشة.**
        //
        // ⛔⛔★★ **والمعرّفُ لا يُمَسّ** — ★ **السجلُّ السياقي 🕘 يستعلم به
        //    وحدَه** (`FR-M18-10`): ⟵ **فالرقمُ حقلٌ يُضاف** ⛔ **لا بديلٌ
        //    عن `entityId`.**
        documentNumber: request.documentNumber,
        sourceId: request.sourceId,
