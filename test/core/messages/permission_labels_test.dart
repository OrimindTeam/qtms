...
void main() {
  group('★★ BR-M1-07 — كل مفتاح باسمه العربي من الكتالوج حرفياً', () {
    ...
    test('★ المستند يحمل السبعة والثمانين مفتاحاً — وإلا فالقراءة مكسورة', () {
      ...
      // ★ **و`discountBackdate` آخرُها** — `WU-013` (`FR-M13-06` §4):
      //   ★★ **81 ⟵ 85 وفُحص عمداً** — ⟵ **مفتاحٌ يُسمّيه المتطلب صراحةً**
      //   ⛔ **ولم يكن في الكتالوج**، ★ **ونظيرُه `receiptBackdate` قائمٌ**
      //   ⛔ **ولا يُغني عنه.**
      // ★★★ **و85 ⟵ 87 في `WU-017`** — ★ **مفتاحا كشف الحساب**
