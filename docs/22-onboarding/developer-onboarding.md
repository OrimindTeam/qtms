...
| ④ | ★ **العمليات المستدعاة تُنادى بـ**[`callable_client.dart`](../../lib/core/callable/callable_client.dart) **وعنوانها من `--dart-define=QTMS_FUNCTIONS_BASE_URL`** | ⚠️ **معرّف لا سرّ** · ⛔ **وبناءٌ بلا ضبطه يفشل ظاهراً لا صامتاً** |
