...
| البند | القيمة |
|---|---|
| **الحالة** | ⏳ **منفَّذ جزئياً** (2026-08-29) — ✅ **`M12` المقبوضات والفائض والإيداع البنكي وحساب المقوت** (`WU-007`) · ⛔ **و`M13` الخصومات** (`WU-013`) **و`M17` كشف الحساب** (`WU-017`) **لم يُنفَّذا بعد** |
