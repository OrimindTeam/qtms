...
| **الإجماليات** | ★★★ **سطرٌ عدديٌّ شامل دائماً، وسطرُ «إجمالي السكرب» عند وجوده وحده** — [`CR-011`](../../02-requirements/change-requests/CR-011-message-totals-count-and-scrap.md) ⏳ **مقترح** · `AM-012` §4.3: ⟵ **«الإجمالي: 60 حبة» ثم «إجمالي السكرب: 0.500 كجم»**، ⛔ **ولا «+ 0.000 كجم» حين لا سكرب.** ★ **والفصلُ بين الوحدتين أقوى مما كان لا أضعف** (`E-31` · `GR-19` بحرفهما) — ⛔ **ولا رقمَ ثالثٌ يجمعهما.** ⚠️ **وكان: «الإجمالي: 60 حبة + 0.500 كجم»** |
...
| ★★ **بادئةُ اسم المقوت** | ★★★ **«الأخ / {اسم المقوت}»** — `AM-012` §4.1: ⟵ **بفراغٍ حول الشرطة**، ★ **في القوالب الأربعة والنسخة المختصرة معاً** ⛔ **بلا استثناء.** ⚠️ **وكانت ملتصقة: «الأخ/ …»** |
...
## ★★ موضعُ زرّ الإرسال بعد `AM-009` ⑦ (2026-08-31)

★★★ **انتقل زرُّ «إرسال أو تصدير» من داخل نموذج التوزيعة إلى صفِّ إجراءات
سجلِّ المقوت** في شاشة التوزيع — ⟵ **فصار الإرسالُ في متناول اليد مباشرةً
من القائمة**، ⛔ **وكان يتطلّب فتحَ نموذجِ تعديلٍ للوصول إليه.**

⛔⛔ **والعقدُ لم يتغيّر بحرف:**

- ⛔ **لا يظهر لمن لا يملك `messagingSend` ولا `documentExport`** — ★ **ولا
  يظهر معطَّلاً** (`ui-guidelines.md` §2).
- ⛔ **ولا يظهر قبل الحفظ** — ★ **فالسجلُّ لا يوجد أصلاً قبله**: ⟵ **ورسالةٌ
  بتوزيعةٍ لم تُحفَظ تَعِد المقوتَ بما قد لا يقع.**
- ⚠️⚠️ **والقالب ② مشروطٌ بشرطين معاً** — **كلُّ السطور مسعَّرة** (`FR-M20-03`)
  **والرصيد مقروءٌ فعلاً**، ⛔ **ولا يُخترَع صفرٌ لمن لا يملك `dealerBalanceView`.**
- ⛔⛔ **ولا يحسب الزرُّ شيئاً** — ★ **الأسعار من `pricing/current` والرصيد من
  `dealer_balances` والنصوص من طبقة النطاق** (`ADR-0011` · `design-system.md` §5.1).
