...
|---|---|---|
| **`M7`** | **ثلاثة**: ضريبة الكيلو · الأنواع لم تُدخل · ⏳ **الوزن الضائع لم يُؤكَّد** (**بشرط توقيتٍ ثانٍ — §12.2-أ**) | كلُّ مسارات الجونية السبعة (`createSack` وأخواتُها) |
...
### 12.2-أ ⏳✅★★★ شرطُ التوقيت الوحيد في المركز — «الوزن الضائع» وحدَه (`CR-013` · 2026-09-17)

★ **حُسم بـ`OQ-002` (الخيار ب)** — ⟵ **وهذا نصُّ القاعدة المُلزِمة:**

> ⏳★★★ **بندُ «الوزن الضائع لم يُؤكَّد» لا يُكتَب ما دام تاريخُ مخزون
> الجونية هو يومَ المنصّة الجاري** — ★ **ويُكتَب عند أوّلِ عمليةٍ تمسّ
> الجونية بعد أن يتغيّر ذلك التاريخ.**

| البند | الحكم |
|:-:|---|
| **مَن يقيس التغيّر** | ★ **`platformDayOf` داخل المعاملة نفسِها** (`GR-54`) — ⛔ **لا ساعةُ الحاوية ولا قيمةٌ من الجهاز** |
| **الدالةُ الحاكمة** | ★ **`isSackLostWeightDue(stockDate, today)` في طبقة النطاق** — ⛔ **ولا نسخةَ ثانية من الشرط في السحابة ولا في الشاشة** (`coding-standards.md` §2.2) |
| **يومُ منصّةٍ لم يصل** | ★ **تأجيلٌ لا ظهورٌ بالشكّ** — ⟵ **نظيرُ `isAgedRemainder` حرفياً**: ⛔ **ولا رجوعَ إلى ساعةٍ محلية** |
| **البندُ المكتوب سابقاً لجونيةِ اليوم** | ★ **يدخل `clearedIds` فيُمحى** عند أوّلِ عمليةٍ تمسّ جونيتَه — ⛔ **ولا يبقى يتيماً** |
| **الحقلان الآخران** | ⛔ **بلا أيِّ شرط توقيت** — ★ **`E-06` كما هو حرفياً**: ⟵ **ضريبةٌ لم تُدخَل وأنواعٌ لم تُدخَل نقصٌ من لحظته** |
| **الدلالة والعدّاد** | ★ **⏳ برتقالية موحّدة كما هي** (§4) · ★ **والعدّادُ يعدّ ما كُتب** — ⛔ **ولا معادلةَ عدٍّ تغيّرت** |

**⛔⛔ ولماذا حدثٌ لا مهلة — §12.2 نفسُها هي السبب:**
★ **مهلةٌ بالساعات كانت ستجعل ظهورَ البند تابعاً لمرور الزمن لا لحدثٍ في
معاملة** — ⟵ **فتستلزم مسارَ كتابةٍ مجدولاً جديداً** ⛔ **ولا مجدولةَ واحدة
في هذا المكدّس** (`aged_remainder.dart` نصّاً)، ★ **وتستلزم رقماً مخترَعاً**
⛔ **يمنعه مبدأ «لا اختلاق».** ✅ **وتغيّرُ تاريخ المخزون بخلافها حدٌّ قائمٌ
أصلاً** — ★ **هو بعينه حدُّ `isAgedClearanceOn` و`isAgedRemainder`.**

> ⚠️⚠️★★ **وحدٌّ معلَنٌ لا يُطوى — وهو ثمنُ البقاء داخل §12.2:** ★ **ظهورُ
> البند يقع عند أوّلِ عمليةٍ سحابيةٍ تمسّ الجونية في يومٍ لاحق** ⛔ **لا عند
> منتصف الليل بذاته**: ⟵ **فجونيةٌ تُترك بوزنٍ غير مفسَّر ولا تُمَسّ مرةً
> أخرى أبداً لا يظهر لها هذا البند.** ★ **وما يُبقيها مرئيةً حينئذٍ ثلاثةٌ
> معاً:** ① **بنداها الآخران إن كانا ناقصين — وهما بلا تأجيل** · ② **الوزنُ
> المتبقي معروضٌ لحظياً في شاشة الجونية** (`FR-M7-17`) · ③ **وقائمةُ المتبقي
> المتأخر** (`FR-M8-09`) **تُبقي رصيدَها الموجب ظاهراً يوماً بعد يوم.**
> ⛔⛔ **ولا تُعالَج هذه الفجوة بمجدولةٍ ولا بأداةِ كنس** — ★ **وعلاجُها إن
> لزم مسارُ إعادة بناءٍ للمركز** (`PAT-07` · نظيرُ `rebuildDayRetroactively`)
> ⟵ **وهو عملٌ مستقلٌّ لم يُطلَب.**
...
## 13. ✅★★★ بطاقةٌ واحدةٌ لكلِّ مستند — لا بطاقةٌ لكلِّ قيمةٍ ناقصة (`AM-025` ① · 2026-09-17)

**العطلُ الذي يعالجه هذا القسم — مقيسٌ بلقطةٍ فعلية لا مفترَض**
(`ux_review_evaluation/screens/pending_entries_screen.md`): ★ **«جونية رقم 2»
ظهرت ببطاقتين متتاليتين عنوانُهما وسطرُهما الثانوي متطابقان حرفياً** — **نفسُ
رقم المستند ونفسُ تاريخ المخزون** — ⟵ **والفارقُ الوحيد شارةٌ أسفل كلٍّ منهما**
(«ضريبة الكيلو» · «الوزن الضائع لم يُؤكَّد»). ⛔ **وهو صحيحٌ وظيفياً بنصِّ §3
(سجلٌّ لكلِّ قيمةٍ معلَّقة) لكنه خطأُ عرضٍ:** ★ **المسحُ السريع يقرأ البطاقتين
مستندين مختلفين** ⛔ **لا مستنداً واحداً ينقصه شيئان.**

### القاعدة المُلزِمة (نصّاً)

> ★★★ **بنودُ المستند الواحد تُعرَض في بطاقةٍ واحدة:** **العنوانُ ورقمُ
> المستند وتاريخُه مرةً واحدة**، ثم **شارةٌ لكلِّ قيمةٍ ناقصة في `Wrap` واحد**،
> ثم **زرُّ [ إدخال ] واحد** ينتقل للشاشة الهدف المشتركة.

| البند | الحكم |
|:-:|---|
| **مفتاحُ التجميع** | ★ **`documentType` + `documentId` معاً** — ⛔ **لا `documentId` وحدَه**: ⟵ **فمعرّفان متطابقان من نوعين مختلفين مستندان مختلفان.** |
| **الترتيب** | ★ **ترتيبُ الدليل محفوظٌ كما وصل** (**التاريخ تنازلياً** — §12.2) ⟵ **والمجموعةُ تقع في موضع أوّلِ بندٍ منها.** |
| **العنوان والسطر الثانوي** | ★ **من أوّلِ بندٍ في المجموعة** — ★ **وهي متطابقةٌ في كلِّ بنودها بحكم `readableTitle` المكتوبِ من المستند نفسِه.** |
| **الشارات** | ★ **شارةٌ ⏳ برتقالية لكلِّ قيمةٍ ناقصة باسمها العربي** — ★ **وثلاثيّتُها `warning` كما هي** (§4): ⛔ **ولا شكلَ بديل.** |
| **الزرّ** | ★ **واحدٌ يفتح وجهةَ أوّلِ بندٍ يملك وجهةً صالحة** — ⛔ **ولا زرَّ لكلِّ شارة**: ★ **كلُّ حقولِ المستند الواحد تُفتَح من شاشته هي** (§6). |
| **مجموعةٌ بلا وجهةٍ إطلاقاً** | ★ **تُعرَض بشاراتها ونصِّ «حدِّث التطبيق لفتح هذا البند»** — ⛔ **ولا تختفي**: ⟵ **اختفاؤها يُخفي نقصاً قائماً** (§7 · `GR-50`). |
| **الوصفُ الدلالي** | ★ **العنوان ثم كلُّ القيم الناقصة مفصولةً بـ` · `** — ⟵ **فقارئُ الشاشة يسمع المجموعة مجموعةً.** |

> ⛔⛔★★ **وما لم يتغيّر — ولا يتغيّر:** ★ **سجلُّ §3 يبقى سطراً لكلِّ قيمةٍ
> معلَّقة كما هو** (`FR-SYS-09`: **السحابةُ تكتبه وتمحوه بندَ بند**) —
> ⟵ **والتجميعُ عرضٌ في الشاشة وحدَها** ⛔ **لا تغييرٌ في المخطَّط ولا في
> الكاتب ولا في العدّاد**: ★ **و«عددُ البنود المعلّقة» يبقى عددَ القيم لا
> عددَ المستندات** (§4 · لوحةُ اليوم).

### 13.1 ✅★★★ توقيتُ «الوزن الضائع لم يُؤكَّد» — **حُسم** (`OQ-002` الخيار ب · 2026-09-17)

★ **كان مرفوعاً هنا بندَ `OQ-002` ولم يُخمَّن** — ✅ **وحسمه المالكُ نصّاً
بالخيار (ب):** ⟵ **«يُؤجَّل ظهور البند … حتى يتغيّر تاريخ المخزون … لا لحظة
حفظ أول سطر أنواع فيها».**

| البند | الموضع |
|:-:|---|
| **القاعدة المُلزِمة كاملةً** | ⟵ **§12.2-أ أعلاه** — ★ **وهي موضعُها الصحيح**: ⛔ **شرطُ كتابةٍ لا قاعدةُ عرض** |
| **مسارُ الحَوْكمة** | ★ **`FR-M7-19` متطلبٌ معتمد** ⟹ [`CR-013`](../../02-requirements/change-requests/CR-013-lost-weight-pending-after-stock-date-change.md) — ⛔ **لا تعديلٌ مباشر** |
| **نصُّ القرار ومبرّرُه** | [`open-questions.md`](../../00-governance/upds-workflow/open-questions.md) `OQ-002` — ★ **وفيه رفضُ (أ) و(ج) و(د) بأسبابها** |
| **حالةُ القبول** | [`TC-TIME-002`](../../08-testing-and-qa/test-cases/TC-TIME-002-lost-weight-pending-after-day-change.md) |

> ⛔⛔★★ **وما لم يتغيّر:** ★ **`BR-M7-12` — الزرُّ الصريح وحده يُسجِّل الوزن
> الضائع** ⛔ **لم يُمَسّ بحرف**: ⟵ **القرارُ في *توقيت التذكير* لا في *شرط
> التسجيل*.** ★ **والدلالةُ ⏳ برتقالية موحّدة كما هي** (§4) — ⛔ **فالخيار
> (د) رُفض لأنه كان سيكسرها.**
