...
| ⛔ **`M22`** | ⛔ **لم يُنفَّذ** — **لا وحدةَ سحبياتٍ بعد** (`WU-014`) | — |

> ★★ **وخمسةُ حقولٍ لا تسعة** — ★ **والمبرّر في ترويسة `PendingMissingField`
...
> ④ **و`M10` بندٌ واحد** (§9 · `AT-23`).

### 12.3 ⚠️ حدود مُعلَنة لا تُطوى

| # | الحدّ | الأثر |
|:-:|---|---|
| 1 | ⛔ **`M22` بلا كاتب** — `FR-M22-07` (بند «قات» بلا سعر) | **يُضاف في `WU-014`** — ★ **بقيمةٍ واحدة في `PendingDocumentKind` وسطرٍ في `PendingMissingField`** |
